<div>
    ...
    <table class="flex-col items-center hidden min-w-full divide-y divide-gray-200 md:table">
        ...
        <div class="flex items-center gap-4 mb-4">
            <x-button class="mt-5" @click="$dispatch('dispatch-message-table-create')">
                Criar menssagem
            </x-button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <x-table-td>
                    <x-ts-button icon="paper-airplane" outline @click="$dispatch('dispatch-message-table-send', { id: '{{ $user->id}}' })"></x-ts-button>
